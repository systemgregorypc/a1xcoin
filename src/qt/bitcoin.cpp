...
int main(int argc, char *argv[])
{
    ...
    app.setOrganizationName("a1xcoin");
    app.setOrganizationDomain("a1xcoin.org");
    if(GetBoolArg("-testnet")) // Separate UI settings for testnet
        app.setApplicationName("a1xcoin-Qt-testnet");
    else
        app.setApplicationName("a1xcoin-Qt");
