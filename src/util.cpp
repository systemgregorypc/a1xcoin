...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\a1xcoin
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\a1xcoin
    // Mac: ~/Library/Application Support/a1xcoin
    // Unix: ~/.a1xcoin
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "a1xcoin";
#else
    fs::path pathRet;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "a1xcoin.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "a1xcoind.pid"));
...
std::string FormatSubVersion(const std::string& name, int nClientVersion, const std::vector<std::string>& comments)
{
    ...
    ss << "/";
    ss << "a1xcoin:" << FormatVersion(PEERUNITY_VERSION);
    ss << "(" << CLIENT_BUILD << ")/";
    return ss.str();
}
