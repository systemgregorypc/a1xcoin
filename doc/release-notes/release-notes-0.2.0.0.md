a1xcoin version 0.2.0.0 is now available from:
...
wallet.dat and a1xcoin.conf

Linux : ~/.a1xcoin/

Windows : %appdata%\Roaming\a1xcoin
...
Icons and other image files updated to replace incorrect a1xbase branding.
...
- `62a3da1` Update GitHub URLs to point to systemgregorypc/a1xcoin
...
- `19ca0ef` Point GitHub URL to github.com/systemgregorypc/a1xcoin
