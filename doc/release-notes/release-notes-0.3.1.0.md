a1xcoin version 0.3.1.0 is now available from:
...
a1xcoin data directory (listed below) and delete everything except the wallet.dat and a1xcoin.conf
...
- `6a3e798` a1xcoin-Qt (Windows only): enable DEP for a1xcoin-qt.exe
...
Miscellaneous:
- `fb66d3f` remove pre-a1xcoin protocol versions
...
- jose grgorio hernandez calderon ( system gregory p.c )
