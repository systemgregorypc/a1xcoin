a1xcoin version 0.3.0.0 is now available from:
...
or just copy over /Applications/a1xcoin-Qt (on Mac) or ax1coind/a1xcoin-qt (on Linux).
...
- `bfe7f71` use a1xcoin keys for tests
- `971cc03` use a1xcoin transaction for tests
- `fb9f6ab` use new version for tests
- `e805876` Remove checknbits test
- `3eb37a5` remove loop define
- `c10e31d` Rename test_bitcoin.cpp to test_a1xcoin.cpp
